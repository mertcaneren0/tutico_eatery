...
const orderOptions = [
  ...
  {
    name: 'Yemeksepeti',
    url: 'https://www.yemeksepeti.com/restaurant/sgyz/tutico-eatery',
    color: 'bg-red-600',
    hoverColor: 'hover:bg-red-700',
  },
  {
    name: 'Trendyol Yemek',
    url: 'https://tgoyemek.com/?utm_source=trendyolgo&utm_medium=referral&utm_campaign=CTA',
    color: 'bg-orange-600',
    hoverColor: 'hover:bg-orange-700',
  },
  {
    name: 'WhatsApp Sipariş',
    url: 'https://wa.me/905449107680',
    color: 'bg-green-600',
    hoverColor: 'hover:bg-green-700',
  },
  {
    name: 'QR Menü',
    url: 'https://view.qrall.co/tr?tenantId=3a19db41-2cb9-f8da-daf2-db752e3bb6ee&channelId=3a19db41-2fb2-44a7-0b88-1f0a8a79fe0b',
    color: 'bg-blue-600',
